...
--
-- Hôte : localhost:3306
-- Généré le :  mer. 31 oct. 2018 à 16:55
...
(7, 'Classic', 'Sandwich: Burger, Fromage, Bacon, Salade, Tomate et cornichon', 8, 'b1.png', 2),
...
(18, 'Cesar Poulet Pane', 'Poulet Pane, Salade, Tomate et la fameuse sauce Cesar', 9.9, 'sa1.png', 4),
(19, 'Cesar Poulet Grille', 'Poulet Grille, Salade, Tomate et la fameuse sauce Cesar', 8.9, 'sa2.png', 4),
(20, 'Salade Light', 'Salade, Tomate, Concombre, Maïs et Vinaigre balsamique', 5.9, 'sa3.png', 4),
(21, 'Poulet Pane', 'Poulet Pane, Salade, Tomate et la sauce de votre choix', 7.9, 'sa4.png', 4),
(22, 'Poulet Grille', 'Poulet Grille, Salade, Tomate et la sauce de votre choix', 7.9, 'sa5.png', 4),
...
(32, 'Milkshakes', 'Au choix: Fraise, Vanille ou Chocolat', 4.9, 'd4.png', 6);
